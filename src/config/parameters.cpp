...
const std::string JSON_backendNoCompoundOperators =
    "backendNoCompoundOperators";
 ...
 */
bool Parameters::isVerboseOutput() const { return _verboseOutput; }

/**
 * @return Keep all functions in the decompiler's output.
 * Otherwise, only functions reachable from main are kept.
 */
bool Parameters::isKeepAllFunctions() const { return _keepAllFunctions; }
...
/**
 * Find out if some functions or ranges were selected in selective
 * decompilation.
...
bool Parameters::isBackendNoOpts() const { return _backendNoOpts; }

bool Parameters::isBackendEmitCfg() const { return _backendEmitCfg; }

bool Parameters::isBackendEmitCg() const { return _backendEmitCg; }
...
bool Parameters::isDetectStaticCode() const { return _detectStaticCode; }

bool Parameters::isTimeout() const { return _timeout != 0; }

void Parameters::setIsVerboseOutput(bool b) { _verboseOutput = b; }

void Parameters::setIsKeepAllFunctions(bool b) { _keepAllFunctions = b; }
void Parameters::setIsSelectedDecodeOnly(bool b) { _selectedDecodeOnly = b; }

void Parameters::setOutputFile(const std::string &n) { _outputFile = n; }
...
void Parameters::setLogFile(const std::string &file) { _logFile = file; }

void Parameters::setErrFile(const std::string &file) { _errFile = file; }

void Parameters::setOrdinalNumbersDirectory(const std::string &n) {
  _ordinalNumbersDirectory = n;
}

void Parameters::setInputFile(const std::string &file) { _inputFile = file; }

void Parameters::setInputPdbFile(const std::string &file) {
  _inputPdbFile = file;
}

void Parameters::setMaxMemoryLimit(uint64_t limit) { _maxMemoryLimit = limit; }

void Parameters::setIsMaxMemoryLimitHalfRam(bool f) {
  _maxMemoryLimitHalfRam = f;
}

void Parameters::setTimeout(uint64_t seconds) { _timeout = seconds; }
...
void Parameters::setIsBackendNoOpts(bool b) { _backendNoOpts = b; }

void Parameters::setIsBackendEmitCfg(bool b) { _backendEmitCfg = b; }

void Parameters::setIsBackendEmitCg(bool b) { _backendEmitCg = b; }
...
void Parameters::setIsDetectStaticCode(bool b) { _detectStaticCode = b; }

const std::string &Parameters::getOrdinalNumbersDirectory() const {
  return _ordinalNumbersDirectory;
}

const std::string &Parameters::getInputFile() const { return _inputFile; }

const std::string &Parameters::getInputPdbFile() const { return _inputPdbFile; }

const std::string &Parameters::getOutputFile() const { return _outputFile; }
...
const std::string &Parameters::getOutputFormat() const { return _outputFormat; }

const std::string &Parameters::getLogFile() const { return _logFile; }

const std::string &Parameters::getErrFile() const { return _errFile; }

uint64_t Parameters::getMaxMemoryLimit() const { return _maxMemoryLimit; }

uint64_t Parameters::getTimeout() const { return _timeout; }
 ...
 * @return JSON object.
 */
template <typename Writer> void Parameters::serialize(Writer &writer) const {
  writer.StartObject();
  ...
  serdes::serializeBool(writer, JSON_selectedDecodeOnly,
                        isSelectedDecodeOnly());
  serdes::serializeString(writer, JSON_ordinalNumDir,
  ...
  serdes::serializeString(writer, JSON_outputBitcodeFile,
  ...
  serdes::serializeString(writer, JSON_outputUnpackedFile,
  ...
  serdes::serializeString(writer, JSON_backendDisabledOpts,
                          getBackendDisabledOpts());
  serdes::serializeString(writer, JSON_backendEnabledOpts,
                          getBackendEnabledOpts());
  serdes::serializeString(writer, JSON_backendCallInfoObtainer,
                          getBackendCallInfoObtainer());
  serdes::serializeString(writer, JSON_backendVarRenamer,
  ...
  serdes::serializeBool(writer, JSON_backendKeepAllBrackets,
                        isBackendKeepAllBrackets());
  serdes::serializeBool(writer, JSON_backendKeepLibraryFuncs,
                        isBackendKeepLibraryFuncs());
  serdes::serializeBool(writer, JSON_backendNoTimeVaryingInfo,
                        isBackendNoTimeVaryingInfo());
  serdes::serializeBool(writer, JSON_backendNoVarRenaming,
                        isBackendNoVarRenaming());
  serdes::serializeBool(writer, JSON_backendNoCompoundOperators,
                        isBackendNoCompoundOperators());
  serdes::serializeBool(writer, JSON_backendNoSymbolicNames,
  ...
  serdes::serializeBool(writer, JSON_maxMemoryLimitHalfRam,
                        isMaxMemoryLimitHalfRam());

  serdes::serializeContainer(writer, JSON_selectedRanges, selectedRanges);
  serdes::serializeContainer(writer, JSON_userStaticSigPaths,
                             userStaticSignaturePaths);
  serdes::serializeContainer(writer, JSON_staticSigPaths, staticSignaturePaths);
  serdes::serializeContainer(writer, JSON_libraryTypeInfoPaths,
                             libraryTypeInfoPaths);
  serdes::serializeContainer(writer, JSON_cryptoPatternPaths,
                             cryptoPatternPaths);
  ...
  serdes::serializeContainer(writer, JSON_selectedNotFoundFncs,
...
template void
Parameters::serialize(rapidjson::PrettyWriter<rapidjson::StringBuffer> &) const;
...
void Parameters::deserialize(const rapidjson::Value &val) {
  ...
  setIsSelectedDecodeOnly(
      serdes::deserializeBool(val, JSON_selectedDecodeOnly));
  setOrdinalNumbersDirectory(
      serdes::deserializeString(val, JSON_ordinalNumDir));
  ...
  setOutputUnpackedFile(
      serdes::deserializeString(val, JSON_outputUnpackedFile));
  ...
  setIsDetectStaticCode(
      serdes::deserializeBool(val, JSON_detectStaticCode, true));
  setBackendDisabledOpts(
      serdes::deserializeString(val, JSON_backendDisabledOpts));
  setBackendEnabledOpts(
      serdes::deserializeString(val, JSON_backendEnabledOpts));
  setBackendCallInfoObtainer(
      serdes::deserializeString(val, JSON_backendCallInfoObtainer, "optim"));
  setBackendVarRenamer(
      serdes::deserializeString(val, JSON_backendVarRenamer, "readable"));
  ...
  setIsBackendKeepAllBrackets(
      serdes::deserializeBool(val, JSON_backendKeepAllBrackets, false));
  setIsBackendKeepLibraryFuncs(
      serdes::deserializeBool(val, JSON_backendKeepLibraryFuncs, false));
  setIsBackendNoTimeVaryingInfo(
      serdes::deserializeBool(val, JSON_backendNoTimeVaryingInfo, false));
  setIsBackendNoVarRenaming(
      serdes::deserializeBool(val, JSON_backendNoVarRenaming, false));
  setIsBackendNoCompoundOperators(
      serdes::deserializeBool(val, JSON_backendNoCompoundOperators, false));
  setIsBackendNoSymbolicNames(
      serdes::deserializeBool(val, JSON_backendNoSymbolicNames, false));
  ...
  setIsMaxMemoryLimitHalfRam(
      serdes::deserializeBool(val, JSON_maxMemoryLimitHalfRam, true));
  ...
  serdes::deserializeContainer(val, JSON_userStaticSigPaths,
                               userStaticSignaturePaths);
  serdes::deserializeContainer(val, JSON_libraryTypeInfoPaths,
                               libraryTypeInfoPaths);
  serdes::deserializeContainer(val, JSON_cryptoPatternPaths,
                               cryptoPatternPaths);
  ...
  serdes::deserializeContainer(val, JSON_selectedNotFoundFncs,
                               selectedNotFoundFunctions);
